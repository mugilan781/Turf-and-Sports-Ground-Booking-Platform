...
(function(window) {
  ...
  const SVG_DEFS = {
    ...
    clock: `<svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10" fill="currentColor" fill-opacity="0.1"/><polyline points="12 6 12 12 16 14"/><circle cx="12" cy="12" r="1.5" fill="currentColor"/></svg>`,
    ...
    // ── Dashboard & System ──
    user: `<svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" fill="currentColor" fill-opacity="0.1"/><circle cx="12" cy="7" r="4" fill="currentColor" fill-opacity="0.2"/></svg>`,
